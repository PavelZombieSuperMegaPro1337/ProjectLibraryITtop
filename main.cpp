...
struct Chel {
    ...
    char fam[30];
    int kartochka;
    int skolko_vzyal; // сколько книг на руках
};
...
void zagruzit() {
    ...
    if (f != NULL) {
        ...
        printf("Файл с книжками не найден\n");
    }
...
int main() {
    ...
    printf("Авторы: Алёхин Павел и Ганичев Адрей\n\n");
